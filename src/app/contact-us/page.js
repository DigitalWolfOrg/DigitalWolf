      ...
      <div className="container contact-main appMobilePadding contactusContainer">
        ...
        <div className="row mt-3">
          <div className="col-md-7">
            ...
            <p className="contactUsPara mt-2">Fill in this form or <span style={{textDecoration:'underline'}}><a style={{color:'#AFAFAF'}} href="mailto:info@digitalwolf.com">send us an e-mail</a></span></p>
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <ul className="phone-details gap-2">
                  ...
                  <li><a href="mailto:info@digitalwolf.com" style={{color:'black'}}>info@digitalwolf.com</a></li>
                </ul>
              </div>
              <div className="col-md-6">
                <h6>Follow:</h6>
