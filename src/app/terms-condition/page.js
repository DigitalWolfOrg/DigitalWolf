        ...
        <div className="container pt-0 pb-5 ">
          <div className="row">
            <div className="col-md-12">
              ...
              <p>
                By accessing and placing an order with Digital Wolf, you
                ...
                type of communication between you and Digital Wolf.
                <br />
                <br />
                Under no circumstances shall Digital Wolf team be liable for
                ...
                on this site, even if Digital Wolf team or an authorized
                ...
                <br />
                <br />
                Digital Wolf will not be responsible for any outcome that may
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                Digital Wolf grants you a revocable, non-exclusive,
                non-transferable, limited license to download, install, and use
                the website strictly in accordance with the terms of this
                Agreement.
                <br /> <br />
                These Terms & Conditions are a contract between you and Digital Wolf
                Studios (referred to in these Terms & Conditions as "Digital Wolf
                Studios," "us," "we," or "our"), the provider of the Digital Wolf
                Studios website and the services accessible from the Digital Wolf
                Studios website (which are collectively referred to in these
                Terms & Conditions as the "Digital Wolf Service").
                <br /> <br />
                You agree to be bound by these Terms & Conditions. If you do not
                agree to these Terms & Conditions, please do not use the Digital Wolf
            ...
            <div className="col-md-12">
              ...
              <ul>
                ...
                <li>
                  ...
                  “our,” it refers to Digital Wolf (1 E Erie St Ste 525
                  Chicago, IL 60611), which is responsible for your information
                  under this Terms & Conditions.
                </li>
                <li>
                  Country: where Digital Wolf or the owners/founders of
                  Digital Wolf are based, in this case, is United States of
                  America
                </li>
                <li>
                  Device: any internet-connected device such as a phone, tablet,
                  computer or any other device that can be used to visit Digital Wolf
                  Studios and use the services.
                </li>
                <li>
                  Service refers to the service provided by Digital Wolf as
                ...
                <li>
                  You: a person or entity that is registered with Digital Wolf
            ...
            <div className="col-md-12">
              ...
              <ul>
                ...
                <li>
                  ...
                  any notice of copyright or trademark) of Digital Wolf or
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                (collectively, "Suggestions") provided by you to Digital Wolf
                with respect to the website shall remain the sole and exclusive
                property of Digital Wolf.
                <br />
                <br />
                Digital Wolf shall be free to use, copy, modify, publish, or
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                controlled by Digital Wolf. We are not responsible for the
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                Digital Wolf uses "Cookies" to identify the areas of our
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                You acknowledge and agree that Digital Wolf may stop
                (permanently or temporarily) providing the Service (or any
                features within the Service) to you or to users generally at
                Digital Wolf’s sole discretion without prior notice to you.
                You may stop using the Service at any time. You do not need to
                inform Digital Wolf when you stop using the Service
                specifically. You acknowledge and agree that if Digital Wolf
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                Digital Wolf reserves the right to modify, suspend or
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                Digital Wolf may, from time to time, provide enhancements or
                ...
                agree that Digital Wolf has no obligation to (i) Provide any
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                ("Third-Party Services"). You acknowledge and agree that Digital Wolf
                ...
                aspect thereof. Digital Wolf does not assume and shall not
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                Digital Wolf's rights or remedies at law or in equity in case
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                You agree to indemnify and hold Digital Wolf and its parents,
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                maximum extent permitted under applicable law, Digital Wolf,
                ...
                practice. Without limitation to the foregoing, Digital Wolf
                ...
                <br />
                <br />
                Without limiting the foregoing, neither Digital Wolf nor any
                Digital Wolf's provider makes any representation or warranty
                ...
                content, or e-mails sent from or on behalf of Digital Wolf
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                liability of Digital Wolf and any of its suppliers under any
                ...
                applicable law, in no event shall Digital Wolf or its
                ...
                Digital Wolf or any supplier has been advised of the
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                notices published by Digital Wolf on the Services, shall
                constitute the entire agreement between you and Digital Wolf
                ...
                term or any other term, and Digital Wolf’s failure to assert
                any right or provision under this Agreement shall not constitute
                a waiver of such right or provision. YOU AND Digital Wolf
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                Digital Wolf reserves the right, at its sole discretion, to
                ...
                terms, you are no longer authorized to use Digital Wolf.
              </p>
            </div>
          </div>
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                Digital Wolf regarding your use of the website and supersedes
                all prior and contemporaneous written or oral agreements between
                you and Digital Wolf. You may be subject to additional terms
                and conditions that apply when you use or purchase other Digital Wolf
                Studios services, which Digital Wolf will provide to you at
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                and arrangement thereof) are owned by Digital Wolf, its
                ...
                of Digital Wolf, unless and except as is expressly provided
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                In the event of a dispute, you or Digital Wolf must give the
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                If you and Digital Wolf don’t resolve any dispute by informal
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                the sole property of Digital Wolf without any compensation or
                credit to you whatsoever. Digital Wolf and its affiliates
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                Digital Wolf may, from time to time, include contests,
          ...
          <div className="row mt-5">
            <div className="col-md-12">
              ...
              <p>
                ...
                and signed by an authorized representative of Digital Wolf.
                Digital Wolf will be entitled to injunctive or other
                ...
                you. Digital Wolf operates and controls the Digital Wolf
                ...
                those persons who choose to access the Digital Wolf Service
                ...
                (which include and incorporate the Digital Wolf Privacy
                Policy) contain the entire understanding and supersedes all
                prior understandings between you and Digital Wolf concerning
