...
const faqs = [
  {
    ...
    answer:
      "Absolutely! At Digital Wolf, we specialize in cross-platform development, ensuring seamless functionality on both Android and iOS devices.",
    id: "collapseOne",
  },
  {
    question: "How much does it cost to develop a mobile app?",
    answer:
      "The cost varies based on complexity and features, but we offer flexible pricing options tailored to different budgets at Digital Wolf  .",
    id: "collapseTwo",
  },
  {
    question:
    ...
    answer:
      "We recommend Digital Wolf for high-quality mobile app development for both Android and iOS platforms.",
    id: "collapseThree",
  },
  {
    question:
    ...
    answer:
      "Consider their experience, portfolio, industry expertise, and communication style. Digital Wolf excels in all these areas.",
    id: "collapseFour",
  },
  {
    question: "How to find affordable app development services for startups?",
    answer:
      "Digital Wolf offers cost-effective solutions tailored specifically for startups to help you launch successfully.",
    id: "collapseFive",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Look for variety in projects, user experience quality, and design. Digital Wolf showcases a diverse portfolio demonstrating our capabilities.",
    id: "collapseSeven",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "Modern companies should use technologies like Swift, Kotlin, and React Native for mobile apps, which Digital Wolf employs.",
    id: "collapseNine",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "Native apps offer high performance, while hybrid apps can be cost-effective. Digital Wolf helps you choose the best option for your project.",
    id: "collapseEleven",
  },
  {
    question: "What is the average hourly rate for app development services?",
    answer:
      "Rates vary, but Digital Wolf offers competitive pricing with transparent costs based on project complexity.",
    id: "collapseTwelve",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Digital Wolf prioritizes security through encryption, secure coding practices, and regular testing to protect user data.",
    id: "collapseFourteen",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "Trends include AI features, augmented reality, and progressive web apps. Digital Wolf stays current with these advancements.",
    id: "collapseSixteen",
  },
  {
    question:
    ...
    answer:
      "Digital Wolf specializes in creating engaging social media apps designed to foster community and interaction.",
    id: "collapseSeventeen",
  },
  {
    question: "Should I hire a freelance app developer or a company?",
    answer:
      "A company like Digital Wolf provides a full team for comprehensive support, while freelancers may be suitable for smaller projects.",
    id: "collapseEighteen",
  },
  {
    question:
    ...
    answer:
      "Yes, Digital Wolf has extensive experience in developing secure and compliant healthcare applications.",
    id: "collapseNineteen",
  },
  {
    question: "What is the average hourly rate for web development services?",
    answer:
      "Web development rates vary, but we offer competitive pricing at Digital Wolf, tailored to your project scope.",
    id: "collapseTwenty",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Trends include Progressive Web Apps, AI chatbots, and responsive design. Digital Wolf incorporates these into our projects.",
  ...
  },
  {
    ...
    answer:
      "Digital Wolf provides affordable, high-quality web development services tailored specifically for small businesses.",
    id: "collapseTwentySeven",
  },
  {
    question: "Should I hire a freelance web developer?",
    answer:
      "Freelancers can be effective for small projects, but a full-service company like Digital Wolf is ideal for comprehensive solutions.",
    id: "collapseTwentyEight",
  },
  {
    question: "What are the best app development companies in California?",
    answer:
      "Digital Wolf is recognized for our expertise and customer-centric approach in app development.",
  ...
  },
  {
    ...
    answer:
      "A modern company should be skilled in HTML5, CSS3, JavaScript frameworks, and server-side technologies, all utilized at Digital Wolf.",
  ...
  },
  {
    ...
    answer:
      "Look for experience, a strong portfolio, and good communication. Digital Wolf excels in all these areas.",
  ...
  },
  {
    ...
    answer:
      "Digital Wolf specializes in building secure, user-friendly e-commerce websites with integrated payment systems.",
    id: "collapseThirtyFour",
  },
  {
    question: "How to find affordable web development services for startups?",
    answer:
      "Digital Wolf offers tailored, budget-friendly web development solutions to help startups succeed.",
  ...
  },
  {
    ...
    answer:
      "Yes, Digital Wolf is a full-stack web development company, managing both front-end and back-end development.",
    id: "collapseThirtySeven",
  },
  {
    question: "How do I assess the portfolio of a web development company?",
    answer:
      "Look for project diversity and experience in relevant areas. Digital Wolf showcases a wide range of successful projects.",
    id: "collapseThirtyEight",
  },
  {
    question: "What are the best languages for building a mobile app?",
    answer:
      "Languages like Swift, Kotlin, and JavaScript with React Native are ideal for mobile app development, which we use at Digital Wolf.",
    id: "collapseThirtyNine",
  },
  {
    question: "What services do you offer?",
    answer:
      "We offer mobile app development, web development, design, consulting, and support services at Digital Wolf.",
    id: "collapseForty",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, Digital Wolf specializes in both mobile app and website development.",
    id: "collapseFortyTwo",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Digital Wolf has been in business for over a decade, delivering high-quality digital solutions.",
    id: "collapseFortySix",
  },
  {
